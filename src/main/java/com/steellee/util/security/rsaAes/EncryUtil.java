...
public class EncryUtil {
	 ...
	 * 生成RSA签名
	 */
	public static String handleRSA(HashMap<String, Object> map,
			String privateKey) {
	...
	public static boolean checkDecryptAndSign(String data, String encrypt_key,
		...
		String realData = ConvertUtils.hexStringToString(AESCoder.decryptFromBase64(data, AESKey));
		
		HashMap<String, String> map = JSON.parseObject(realData,
	 ...
	 * 生成hmac
	 */
	public static String handleHmac(HashMap<String, String> map, String hmacKey) {
		StringBuffer sbuffer = new StringBuffer();
